...
<body class="bg-stone-950 text-stone-100 min-h-screen flex items-center justify-center">
    <div class="text-center px-6">
        <div class="text-8xl font-bold text-stone-800 select-none mb-2">500</div>
        <h1 class="text-xl font-semibold text-stone-200 mb-2">Terjadi kesalahan server</h1>
        <p class="text-sm text-stone-500 mb-8 max-w-sm mx-auto">
            Kami sedang mengalami gangguan teknis. Silakan coba beberapa saat lagi.
        </p>
        <a href="{{ route('home') }}"
